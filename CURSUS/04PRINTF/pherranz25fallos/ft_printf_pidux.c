...
/*   Updated: 2021/04/24 19:48:11 by pherranz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	printdir(t_printf *st, unsigned long int p)
{
...
void	printint(t_printf *st, va_list args)
{
	if (st->cv == 'i' || st->cv == 'd')
	{
...
void	printhexu(t_printf *st, va_list args)
{
	st->num = va_arg(args, unsigned int);
	if (st->cv == 'x')
