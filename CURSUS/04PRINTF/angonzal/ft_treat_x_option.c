...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/17 18:56:50 by angonzal          #+#    #+#             */
/*   Updated: 2021/03/20 17:16:23 by angonzal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** This functions treat "x" or "X" option for printf integer in base 16
*/
...
static int		ft_in_put_part_hexa(char *hexa, t_flags flags)
{
	...
	char_count += ft_treat_str_prec(hexa, ft_strlen(hexa));
	return (char_count);
}
